<?php
    ...
    // Entering thing to search for!
    $search = mysqli_real_escape_string($con,strip_tags($_POST['search']));

    // searching for that substance!
    $data = "SELECT * FROM products WHERE pname = '$search' OR ptype = '$search'";
